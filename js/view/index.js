...
export class App {
  static initialize(document) {
    ...
    const resultadoPorcentagem = document.getElementById(
    ...
    const resultadoRaizQuadrada = document.getElementById(
    ...
    btnCalcular.addEventListener("click", () => {
      ...
      resultadoMultiplicacaoInstead.innerHTML = multiplicacao(
        num2.value,
        num1.value
      );

      resultadoPorcentagem.innerHTML =
        porcentagem(num1.value, num2.value) + "%";
      resultadoPorcentagemInstead.innerHTML =
        porcentagem(num2.value, num1.value) + "%";
